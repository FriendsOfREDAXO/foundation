<p class="formselect formlabel-<?php echo $this->getName() ?>" id="<?php echo $this->getHTMLId() ?>">
    <label class="select <?php echo $this->getWarningClass() ?>"
           for="<?php echo $this->getFieldId() ?>"><?php echo $this->getLabel() ?></label>
    <select class="select <?php echo $this->getWarningClass() ?>"
            id="<?php echo $this->getFieldId() ?>" <?php echo $multiple ? 'name="' . $this->getFieldName() . '[]" multiple="multiple"' : 'name="' . $this->getFieldName() . '"', $this->getElement("disabled") ? ' disabled="disabled"' : '' ?>
            size="<?php echo $size ?>">
