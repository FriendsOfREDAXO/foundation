<p class="formradio formlabel-<?php echo $this->getName() ?>" id="<?php echo $this->getHTMLId() ?>">
    <label class="radio <?php echo $this->getWarningClass() ?>"
...
<p class="radio">
    <input type="radio" class="radio" id="<?php echo $id ?>" name="<?php echo $this->getFieldName() ?>"
           value="<?php echo htmlspecialchars($key) ?>"<?php echo $key == $this->getValue() ? ' checked="checked"' : '' ?> />
